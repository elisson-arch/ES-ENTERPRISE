...
import type { Client, SyncLog } from '../types';
...
const mockClients: Client[] = [
  {
    ...
    phone: '(11) 98765-4321',
    address: 'Av. das Flores, 450 - São Paulo, SP',
    type: 'Comercial',
    assets: [],
    origin: 'Manual',
    status: 'Ativo',
  ...
  },
  {
    ...
    email: 'adm@saoluiz.com.br',
    phone: '(11) 5566-7788',
    address: 'Rua das Palmeiras, 100 - SP',
    type: 'Comercial',
    assets: [],
    origin: 'Google',
    status: 'Prospecção',
    ...
    <div className="space-y-6 animate-in fade-in duration-700">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          ...
          <button className="bg-blue-600 text-white px-6 py-3 rounded-xl font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-blue-700 transition-all shadow-xl shadow-blue-100">
              ...
              <div className="flex justify-between items-start mb-6">
                <div className="flex gap-2">
                  <span className={`text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-full border ${
                    client.origin === 'Google' ? 'bg-blue-50 text-blue-600 border-blue-100' : 'bg-slate-50 text-slate-500 border-slate-100'
                  }`}>
                    {client.origin}
                  </span>
