...
const mockAssets: Asset[] = [
  ...
  },
  {
    id: 'a4',
    clientId: '3',
    type: 'Sistema Multi Split 3 ambientes',
    brand: 'Midea',
    model: 'X-Power',
        ...
        <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1 -mx-2 px-2 md:mx-0 md:px-0">
          {CATEGORIES.map(cat => (
            <button
              ...
              className={`flex items-center gap-2.5 px-6 py-3 rounded-xl md:rounded-2xl text-[9px] md:text-[10px] font-black uppercase tracking-widest transition-all border whitespace-nowrap ${
